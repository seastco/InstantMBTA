...
class InkyTrain():
    ...
    def draw_inbound_outbound(self, line, stop1, stop2, s1_next_inbound_str, s1_next_outbound_str, s2_next_inbound_str, s2_next_outbound_str):
        ...
        self.draw.text((10, stop1_y), stop1, self.inky_display.BLACK, font_stop_name)
        ...
        s1_x_inbound = 10
        s1_y_inbound = stop1_y + (s1_h_inbound)
        self.draw.text((s1_x_inbound, s1_y_inbound), s1_inbound_message, self.inky_display.BLACK, font_times)
        ...
        s1_x_outbound = 10
        s1_y_outbound = s1_y_inbound + (s1_h_inbound)
        ...
        self.draw.text((10, stop2_y), stop2, self.inky_display.BLACK, font_stop_name)
        ...
        s2_x_outbound = 10
        s2_y_outbound = stop2_y + (s2_h_outbound)
        self.draw.text((s2_x_outbound, s2_y_outbound), s2_outbound_message, self.inky_display.BLACK, font_times)
